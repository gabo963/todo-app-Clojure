...
var G__47654 = devtools.prefs.pref(v);
v = G__47654;
continue;
} else {
return v;
...
}catch (e47596){var _e__46308__auto__ = e47596;
return false;
}})();
...
}catch (e47599){var _e__46308__auto__ = e47599;
return false;
}})();
...
}catch (e47601){var _e__46308__auto__ = e47601;
return false;
}}
}
});
...
var vec__47617 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47617,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47617,(1),null);
...
return cljs.core.some((function (p1__47624_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__47624_SHARP_);
}),template);
});
