...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_58363 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_58363(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_58368 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_58368(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_58374 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_58374(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_58377 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_58377(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_58386 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_58386(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_58390 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_58390(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__58339,callback){
var map__58340 = p__58339;
var map__58340__$1 = cljs.core.__destructure_map(map__58340);
var input = map__58340__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58340__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58340__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
