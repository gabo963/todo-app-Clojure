...
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58244 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("todo","id","todo/id",-1375661554),id,new cljs.core.Keyword("todo","done","todo/done",-886331930),cljs.core.not(done)], null);
return (app.model.todo.todo_change_done.cljs$core$IFn$_invoke$arity$1 ? app.model.todo.todo_change_done.cljs$core$IFn$_invoke$arity$1(G__58244) : app.model.todo.todo_change_done.call(null,G__58244));
})()], null));
...
return com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("div",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("input",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),text,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Write Something",new cljs.core.Keyword(null,"onChange","onChange",-312891301),(function (p1__58248_SHARP_){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58258 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("todo","id","todo/id",-1375661554),id,new cljs.core.Keyword("todo","text","todo/text",-1787258203),com.fulcrologic.fulcro.dom.events.target_value(p1__58248_SHARP_)], null);
return (app.model.todo.todo_change_text.cljs$core$IFn$_invoke$arity$1 ? app.model.todo.todo_change_text.cljs$core$IFn$_invoke$arity$1(G__58258) : app.model.todo.todo_change_text.call(null,G__58258));
})()], null));
...
var options__52180__auto___58305 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"query","query",-1288509510),(function app$components$ui_todo$query_STAR_(this$){
...
}),new cljs.core.Keyword(null,"ident","ident",-742346),(function app$components$ui_todo$ident_STAR_(this$,p__58286){
var map__58287 = p__58286;
var map__58287__$1 = cljs.core.__destructure_map(map__58287);
var props = map__58287__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58287__$1,new cljs.core.Keyword("todo","id","todo/id",-1375661554));
var done = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58287__$1,new cljs.core.Keyword("todo","done","todo/done",-886331930));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58287__$1,new cljs.core.Keyword("todo","text","todo/text",-1787258203));
...
var map__58291 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58291__$1 = cljs.core.__destructure_map(map__58291);
var props = map__58291__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58291__$1,new cljs.core.Keyword("todo","id","todo/id",-1375661554));
var done = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58291__$1,new cljs.core.Keyword("todo","done","todo/done",-886331930));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58291__$1,new cljs.core.Keyword("todo","text","todo/text",-1787258203));
var map__58292 = (com.fulcrologic.fulcro.components.get_computed.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.get_computed.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.get_computed.call(null,this$));
var map__58292__$1 = cljs.core.__destructure_map(map__58292);
var onDelete = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58292__$1,new cljs.core.Keyword(null,"onDelete","onDelete",1331388507));
 ...
 * @constructor
 */
app.components.ui_todo.Todo = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__52180__auto___58305,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.components.ui_todo.Todo,new cljs.core.Keyword("app.components.ui-todo","Todo","app.components.ui-todo/Todo",1766621371),options__52180__auto___58305);
