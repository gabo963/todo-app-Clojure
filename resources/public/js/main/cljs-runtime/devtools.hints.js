...
var G__41328 = cljs.core.PersistentArrayMap.EMPTY;
var G__41329 = native_stack_trace;
var G__41330 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__41331 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__41328,G__41329,G__41330,G__41331) : cljs.stacktrace.parse_stacktrace.call(null,G__41328,G__41329,G__41330,G__41331));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41334__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41334__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41334__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e41333){var _e = e41333;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___41380 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___41380)){
var seen_errors_41381 = temp__5802__auto___41380;
if(cljs.core.truth_(seen_errors_41381.has(self))){
} else {
seen_errors_41381.add(self);

var temp__5804__auto___41382 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___41382)){
var sense_41383 = temp__5804__auto___41382;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41383)].join('');
} else {
}
}
} else {
