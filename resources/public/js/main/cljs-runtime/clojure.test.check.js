...
var vec__45514 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45514,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45514,(1),null);
...
clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__45527){
...
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45528__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45528__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45528__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__45530 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45530,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45530,(1),null);
...
var size = first__45544;
var rest_size_seq = seq__45543__$1;
var vec__45545 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45545,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45545,(1),null);
...
/** @this {Function} */
clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq45519){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45520,G__45521,seq45519__$2);
});
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45559__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__45563_45615 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45563_45615) : reporter_fn.call(null,G__45563_45615));

var temp__5802__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5802__auto__){
var children = temp__5802__auto__;
var G__45619 = children;
var G__45620 = new_smallest;
var G__45621 = (total_nodes_visited + (1));
var G__45622 = (depth + (1));
nodes = G__45619;
current_smallest = G__45620;
total_nodes_visited = G__45621;
depth = G__45622;
continue;
} else {
var G__45628 = tail;
var G__45629 = new_smallest;
var G__45630 = (total_nodes_visited + (1));
var G__45631 = depth;
nodes = G__45628;
current_smallest = G__45629;
total_nodes_visited = G__45630;
depth = G__45631;
continue;
}
}
...
var G__45568_45639 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45568_45639) : reporter_fn.call(null,G__45568_45639));
...
var G__45570 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__45564_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45570) : reporter_fn.call(null,G__45570));
});})(failed_after_ms,root,result,failure_data))
);
var G__45571_45642 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45571_45642) : reporter_fn.call(null,G__45571_45642));
