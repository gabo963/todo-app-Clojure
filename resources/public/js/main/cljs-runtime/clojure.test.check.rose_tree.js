...
return cljs.core.cons(cljs.core.first(s),(function (){var G__44893 = (n - (1));
var G__44894 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__44893,G__44894) : clojure.test.check.rose_tree.exclude_nth.call(null,G__44893,G__44894));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__44900 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__44900) : f.call(null,G__44900));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44899_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__44899_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__44899_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44901_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__44901_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__44901_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44902_SHARP_){
var G__44903 = clojure.test.check.rose_tree.root(p1__44902_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__44903) : pred.call(null,G__44903));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__44905(s__44906){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__44912 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44912,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44912,(1),null);
var iterys__4519__auto__ = ((function (s__44906__$1,vec__44912,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__44905_$_iter__44907(s__44908){
return (new cljs.core.LazySeq(null,((function (s__44906__$1,vec__44912,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__44908__$1 = s__44908;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__44908__$1);
if(temp__5804__auto____$1){
var s__44908__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__44908__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__44908__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__44910 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__44909 = (0);
while(true){
if((i__44909 < size__4522__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__44909);
cljs.core.chunk_append(b__44910,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__44952 = (i__44909 + (1));
i__44909 = G__44952;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44910),clojure$test$check$rose_tree$permutations_$_iter__44905_$_iter__44907(cljs.core.chunk_rest(s__44908__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44910),null);
}
} else {
var child = cljs.core.first(s__44908__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__44905_$_iter__44907(cljs.core.rest(s__44908__$2)));
}
} else {
return null;
}
...
});})(s__44906__$1,vec__44912,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__44906__$1,vec__44912,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,clojure$test$check$rose_tree$permutations_$_iter__44905(cljs.core.rest(s__44906__$1)));
} else {
var G__44967 = cljs.core.rest(s__44906__$1);
s__44906__$1 = G__44967;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44918_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__44918_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__44918_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44919_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__44919_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__44919_SHARP_));
...
return (function (){
return cljs.core.cons((function (){var G__44920 = f;
var G__44921 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__44920,G__44921) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__44920,G__44921));
})(),(new cljs.core.LazySeq(null,((function (left_count){
return (function (){
return (new cljs.core.List(null,(function (){var G__44922 = f;
var G__44923 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__44922,G__44923) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__44922,G__44923));
})(),null,(1),null));
});})(left_count))
,null,null)));
});})(left_count))
