...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_50155 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_50155(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_50156 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_50156(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_50157 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_50157(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_50158 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_50158(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_50159 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_50159(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_50160 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_50160(reader);
}
});
...
var G__50164 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__50165 = s.append(c);
c = G__50164;
s = G__50165;
continue;
}
