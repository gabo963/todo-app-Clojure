 ...
 */
com.fulcrologic.fulcro.data_fetch.elide_ast_nodes = (function com$fulcrologic$fulcro$data_fetch$elide_ast_nodes(p__52461,elision_predicate){
var map__52462 = p__52461;
var map__52462__$1 = cljs.core.__destructure_map(map__52462);
var ast = map__52462__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52462__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52462__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52462__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52460_SHARP_){
return (com.fulcrologic.fulcro.data_fetch.elide_ast_nodes.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.data_fetch.elide_ast_nodes.cljs$core$IFn$_invoke$arity$2(p1__52460_SHARP_,elision_predicate) : com.fulcrologic.fulcro.data_fetch.elide_ast_nodes.call(null,p1__52460_SHARP_,elision_predicate));
}),c));
}));
 ...
 */
com.fulcrologic.fulcro.data_fetch.load_params_STAR_ = (function com$fulcrologic$fulcro$data_fetch$load_params_STAR_(app__$1,server_property_or_ident,class_or_factory,p__52478){
var map__52479 = p__52478;
var map__52479__$1 = cljs.core.__destructure_map(map__52479);
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"target","target",253001721));
var abort_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"abort-id","abort-id",1559937819));
var remote = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52479__$1,new cljs.core.Keyword(null,"remote","remote",-1593576576),new cljs.core.Keyword(null,"remote","remote",-1593576576));
var update_query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"update-query","update-query",-1566885791));
var fallback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"fallback","fallback",761637929));
var marker = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52479__$1,new cljs.core.Keyword(null,"marker","marker",865118313),false);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"params","params",710516235));
var error_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"error-action","error-action",-1147840498));
var post_mutation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"post-mutation","post-mutation",-1076606705));
var without = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"without","without",1107036688));
var ok_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"ok-action","ok-action",1253795573));
var post_mutation_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"post-mutation-params","post-mutation-params",-849425897));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var post_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52479__$1,new cljs.core.Keyword(null,"post-action","post-action",-542405960));
...
var transformed_query = (cljs.core.truth_(class_or_factory)?(function (){var G__52488 = com.fulcrologic.fulcro.raw.components.get_query.cljs$core$IFn$_invoke$arity$2(class_or_factory,state_map);
var G__52488__$1 = ((cljs.core.set_QMARK_(without))?com.fulcrologic.fulcro.data_fetch.elide_query_nodes(G__52488,without):G__52488);
var G__52488__$2 = (cljs.core.truth_(focus)?edn_query_language.core.focus_subquery(G__52488__$1,focus):G__52488__$1);
if(cljs.core.truth_(update_query)){
return (update_query.cljs$core$IFn$_invoke$arity$1 ? update_query.cljs$core$IFn$_invoke$arity$1(G__52488__$2) : update_query.call(null,G__52488__$2));
} else {
return G__52488__$2;
}
})():null);
...
var map__52504 = app__$1;
var map__52504__$1 = cljs.core.__destructure_map(map__52504);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52504__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
...
var G__52506 = app__$1;
var G__52507 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"force-root?","force-root?",-1598741683),true], null);
return (render_BANG_.cljs$core$IFn$_invoke$arity$2 ? render_BANG_.cljs$core$IFn$_invoke$arity$2(G__52506,G__52507) : render_BANG_.call(null,G__52506,G__52507));
} else {
return null;
}
});
...
if(cljs.core.truth_(marker)){
var map__52518 = app__$1;
var map__52518__$1 = cljs.core.__destructure_map(map__52518);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52518__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
 ...
 */
com.fulcrologic.fulcro.data_fetch.finish_load_BANG_ = (function com$fulcrologic$fulcro$data_fetch$finish_load_BANG_(p__52528,p__52529){
var map__52532 = p__52528;
var map__52532__$1 = cljs.core.__destructure_map(map__52532);
var env = map__52532__$1;
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52532__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52532__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var transmitted_ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52532__$1,new cljs.core.Keyword(null,"transmitted-ast","transmitted-ast",1828931690));
var map__52533 = p__52529;
var map__52533__$1 = cljs.core.__destructure_map(map__52533);
var params = map__52533__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var ok_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"ok-action","ok-action",1253795573));
var post_mutation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"post-mutation","post-mutation",-1076606705));
var post_mutation_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"post-mutation-params","post-mutation-params",-849425897));
var post_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"post-action","post-action",-542405960));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"target","target",253001721));
var marker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"marker","marker",865118313));
var source_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52533__$1,new cljs.core.Keyword(null,"source-key","source-key",-1325875542));
...
var map__52555 = result;
var map__52555__$1 = cljs.core.__destructure_map(map__52555);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52555__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var transaction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52555__$1,new cljs.core.Keyword(null,"transaction","transaction",1777321997));
...
var map__52556 = app__$1;
var map__52556__$1 = cljs.core.__destructure_map(map__52556);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52556__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state_atom,(function (s){
var G__52562 = com.fulcrologic.fulcro.algorithms.merge.merge_STAR_.cljs$core$IFn$_invoke$arity$3(s,query,body__$1);
if(cljs.core.truth_(target)){
return com.fulcrologic.fulcro.algorithms.data_targeting.process_target.cljs$core$IFn$_invoke$arity$3(G__52562,source_key,target);
} else {
return G__52562;
}
}));
 ...
 *   
 */
com.fulcrologic.fulcro.data_fetch.load_failed_BANG_ = (function com$fulcrologic$fulcro$data_fetch$load_failed_BANG_(p__52580,p__52581){
var map__52583 = p__52580;
var map__52583__$1 = cljs.core.__destructure_map(map__52583);
var env = map__52583__$1;
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52583__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var map__52588 = p__52581;
var map__52588__$1 = cljs.core.__destructure_map(map__52588);
var params = map__52588__$1;
var error_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52588__$1,new cljs.core.Keyword(null,"error-action","error-action",-1147840498));
var marker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52588__$1,new cljs.core.Keyword(null,"marker","marker",865118313));
var fallback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52588__$1,new cljs.core.Keyword(null,"fallback","fallback",761637929));
...
var temp__5804__auto___52696 = com.fulcrologic.fulcro.algorithms.lookup.app_algorithm(app__$1,new cljs.core.Keyword(null,"global-error-action","global-error-action",-924822372));
if(cljs.core.truth_(temp__5804__auto___52696)){
var global_error_action_52697 = temp__5804__auto___52696;
(global_error_action_52697.cljs$core$IFn$_invoke$arity$1 ? global_error_action_52697.cljs$core$IFn$_invoke$arity$1(env__$1) : global_error_action_52697.call(null,env__$1));
} else {
}
...
com.fulcrologic.fulcro.mutations.mutate.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("com.fulcrologic.fulcro.data-fetch","internal-load!","com.fulcrologic.fulcro.data-fetch/internal-load!",273645565,null),(function (p__52605){
var map__52606 = p__52605;
var map__52606__$1 = cljs.core.__destructure_map(map__52606);
var env = map__52606__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52606__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(ast,new cljs.core.Keyword(null,"params","params",710516235));
var map__52608 = params;
var map__52608__$1 = cljs.core.__destructure_map(map__52608);
var remote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52608__$1,new cljs.core.Keyword(null,"remote","remote",-1593576576));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52608__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var marker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52608__$1,new cljs.core.Keyword(null,"marker","marker",865118313));
...
var G__52610 = cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.Keyword(null,"action","action",-811238024),(function (p__52611){
var map__52612 = p__52611;
var map__52612__$1 = cljs.core.__destructure_map(map__52612);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52612__$1,new cljs.core.Keyword(null,"app","app",-560961707));
...
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (p__52615){
var map__52616 = p__52615;
var map__52616__$1 = cljs.core.__destructure_map(map__52616);
var env__$1 = map__52616__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52616__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52616__$1,new cljs.core.Keyword(null,"app","app",-560961707));
...
var map__52635 = new cljs.core.Keyword("com.fulcrologic.fulcro.application","config","com.fulcrologic.fulcro.application/config",-1907926684).cljs$core$IFn$_invoke$arity$1(app__$1);
var map__52635__$1 = cljs.core.__destructure_map(map__52635);
var load_marker_default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52635__$1,new cljs.core.Keyword(null,"load-marker-default","load-marker-default",335781105));
var query_transform_default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52635__$1,new cljs.core.Keyword(null,"query-transform-default","query-transform-default",-1684574273));
var load_mutation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52635__$1,new cljs.core.Keyword(null,"load-mutation","load-mutation",-2132703225));
var map__52636 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52639 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"marker","marker",865118313),load_marker_default,new cljs.core.Keyword(null,"parallel","parallel",-1863607128),false,new cljs.core.Keyword(null,"refresh","refresh",1947415525),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"without","without",1107036688),cljs.core.PersistentHashSet.EMPTY], null);
if(cljs.core.truth_(query_transform_default)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52639,new cljs.core.Keyword(null,"update-query","update-query",-1566885791),query_transform_default);
} else {
return G__52639;
}
})(),config], 0));
var map__52636__$1 = cljs.core.__destructure_map(map__52636);
var config__$1 = map__52636__$1;
var parallel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52636__$1,new cljs.core.Keyword(null,"parallel","parallel",-1863607128));
var refresh = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52636__$1,new cljs.core.Keyword(null,"refresh","refresh",1947415525));
...
}),null)),null,-321010958,null);
} else {
}

return com.fulcrologic.fulcro.raw.components.transact_BANG_.cljs$core$IFn$_invoke$arity$3(app__$1,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$1((new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,load_sym,null,(1),null)),(new cljs.core.List(null,mutation_args,null,(1),null))))),null,(1),null)))))),(function (){var G__52645 = txn_options;
var G__52645__$1 = ((cljs.core.seq(refresh))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52645,new cljs.core.Keyword(null,"refresh","refresh",1947415525),refresh):G__52645);
var G__52645__$2 = ((cljs.core.boolean_QMARK_(parallel))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52645__$1,new cljs.core.Keyword(null,"parallel?","parallel?",-25273892),parallel):G__52645__$1);
if(cljs.core.truth_(abort_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52645__$2,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.tx-processing","abort-id","com.fulcrologic.fulcro.algorithms.tx-processing/abort-id",2068829184),abort_id);
} else {
return G__52645__$2;
}
})());
...
var map__52653 = options;
var map__52653__$1 = cljs.core.__destructure_map(map__52653);
var parallel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52653__$1,new cljs.core.Keyword(null,"parallel","parallel",-1863607128));
var update_query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52653__$1,new cljs.core.Keyword(null,"update-query","update-query",-1566885791));
var map__52654 = new cljs.core.Keyword("com.fulcrologic.fulcro.application","config","com.fulcrologic.fulcro.application/config",-1907926684).cljs$core$IFn$_invoke$arity$1(app__$1);
var map__52654__$1 = cljs.core.__destructure_map(map__52654);
var load_mutation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52654__$1,new cljs.core.Keyword(null,"load-mutation","load-mutation",-2132703225));
var load_sym = (function (){var or__5045__auto__ = load_mutation;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var G__52658 = edn_query_language.core.focus_subquery(q,((cljs.core.vector_QMARK_(field_or_fields))?field_or_fields:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [field_or_fields], null)));
if(cljs.core.truth_(update_query)){
return (update_query.cljs$core$IFn$_invoke$arity$1 ? update_query.cljs$core$IFn$_invoke$arity$1(G__52658) : update_query.call(null,G__52658));
} else {
return G__52658;
}
});
...
return com.fulcrologic.fulcro.raw.components.transact_BANG_.cljs$core$IFn$_invoke$arity$3(app__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.List(null,load_sym,(new cljs.core.List(null,params,null,(1),null)),(2),null))], null),(function (){var G__52661 = cljs.core.PersistentArrayMap.EMPTY;
var G__52661__$1 = ((cljs.core.boolean_QMARK_(parallel))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52661,new cljs.core.Keyword(null,"parallel?","parallel?",-25273892),parallel):G__52661);
if(cljs.core.truth_(abort_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52661__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.tx-processing","abort-id","com.fulcrologic.fulcro.algorithms.tx-processing/abort-id",2068829184),abort_id);
} else {
return G__52661__$1;
}
})());
