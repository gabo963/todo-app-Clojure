 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__60135){
var vec__60136 = p__60135;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60136,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60136,(1),null);
var ref = vec__60136;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__60140){
var vec__60141 = p__60140;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60141,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60141,(1),null);
var ref = vec__60141;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__60147){
var map__60148 = p__60147;
var map__60148__$1 = cljs.core.__destructure_map(map__60148);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60148__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__60152,entity,state_map,parent_node,idents_seen){
var map__60153 = p__60152;
var map__60153__$1 = cljs.core.__destructure_map(map__60153);
var join_node = map__60153__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60153__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60153__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__60161,entity,state_map,idents_seen){
var map__60162 = p__60161;
var map__60162__$1 = cljs.core.__destructure_map(map__60162);
var join_node = map__60162__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60162__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__60163){
var map__60164 = p__60163;
var map__60164__$1 = cljs.core.__destructure_map(map__60164);
var node = map__60164__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60164__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__60165 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60165,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__60170 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__60170) : union_key__GT_query.call(null,G__60170));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__60176,current_entity,state_map,idents_seen){
var map__60177 = p__60176;
var map__60177__$1 = cljs.core.__destructure_map(map__60177);
var top_node = map__60177__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60177__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60177__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__60178 = nil_nodes;
var G__60178__$1 = (((G__60178 == null))?null:cljs.core.first(G__60178));
if((G__60178__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__60178__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__60179 = result_node__$1;
var G__60179__$1 = (((G__60179 == null))?null:cljs.core.persistent_BANG_(G__60179));
if((G__60179__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__60179__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__60180 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__60181 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__60181);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__60182 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__60182 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__60182,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__60180);
}});
/**
...
var G__60183 = props;
var G__60183__$1 = (((G__60183 == null))?null:cljs.core.meta(G__60183));
if((G__60183__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__60183__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__60184 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__60185 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__60185);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__60184);
}});
/**
...
var map__60186 = cljs.core.meta(prior_props);
var map__60186__$1 = cljs.core.__destructure_map(map__60186);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60186__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60186__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
