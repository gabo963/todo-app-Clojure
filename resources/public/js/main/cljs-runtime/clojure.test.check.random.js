...
var G__44613 = z;
if(((24) > (function (){var G__44615 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__44615) : clojure.test.check.random.longs.bit_count.call(null,G__44615));
})())){
return clojure.test.check.random.longs.bit_xor(G__44613,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__44613;
}
});
...
var G__44654 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__44655 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__44654;
ret = G__44655;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44635__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__44638 = clojure.test.check.random.split(state);
