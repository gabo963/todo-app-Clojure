...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__62582){
var map__62583 = p__62582;
var map__62583__$1 = cljs.core.__destructure_map(map__62583);
var ast = map__62583__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62583__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62583__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__62584){
var map__62585 = p__62584;
var map__62585__$1 = cljs.core.__destructure_map(map__62585);
var child_ast = map__62585__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62585__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62585__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62585__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__62586 = idx;
var G__62586__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__62586,dispatch_key,parent_key):G__62586);
var G__62586__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__62586__$1,key,parent_key):G__62586__$1);
var G__62586__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__62586__$2,key,parent_key):G__62586__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__62586__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__62586__$3,child_ast));
} else {
return G__62586__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62587__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__62588){
var map__62589 = p__62588;
var map__62589__$1 = cljs.core.__destructure_map(map__62589);
var ast = map__62589__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62589__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62589__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,1206318657,null);

var map__62590 = app__$1;
var map__62590__$1 = cljs.core.__destructure_map(map__62590);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62590__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62590__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__62591 = cljs.core.deref(runtime_atom);
var map__62591__$1 = cljs.core.__destructure_map(map__62591);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62591__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__62593 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__62593__$1 = cljs.core.__destructure_map(map__62593);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62593__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__62597 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__62597__$1 = cljs.core.__destructure_map(map__62597);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62597__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__62598){
var map__62599 = p__62598;
var map__62599__$1 = cljs.core.__destructure_map(map__62599);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62599__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__62600_62605 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__62601_62606 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__62601_62606);
...
}),null)),null,635232041,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__62600_62605);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__62602 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__62603 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__62603);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__62602);
}})], null);
}));
