...
var len__5769__auto___47773 = arguments.length;
var i__5770__auto___47774 = (0);
while(true){
if((i__5770__auto___47774 < len__5769__auto___47773)){
args__5775__auto__.push((arguments[i__5770__auto___47774]));

var G__47775 = (i__5770__auto___47774 + (1));
i__5770__auto___47774 = G__47775;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq47695){
var G__47696 = cljs.core.first(seq47695);
var seq47695__$1 = cljs.core.next(seq47695);
var G__47697 = cljs.core.first(seq47695__$1);
var seq47695__$2 = cljs.core.next(seq47695__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47696,G__47697,seq47695__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__47742_SHARP_){
return (!((cljs.core.meta(p1__47742_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47748__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e47749){var _e__46308__auto__ = e47749;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e47751){var _e__46308__auto__ = e47751;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__47757 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__47758 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__47758);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47759__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__47757);
}});
...
var temp__5802__auto___47796 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___47796)){
var managed_print_level_47797 = temp__5802__auto___47796;
var _STAR_print_level_STAR__orig_val__47765_47798 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__47766_47799 = managed_print_level_47797;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__47766_47799);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__47764_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__47764_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__47765_47798);
}} else {
job_fn();
}
