...
var fexpr__57331 = (function (p__57332,seen__$1){
while(true){
var vec__57333 = p__57332;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57333,(0),null);
var xs__$1 = vec__57333;
var temp__5804__auto__ = cljs.core.seq(xs__$1);
if(temp__5804__auto__){
var s = temp__5804__auto__;
var v = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x));
if(cljs.core.contains_QMARK_(seen__$1,v)){
var G__57390 = cljs.core.rest(s);
var G__57391 = seen__$1;
p__57332 = G__57390;
seen__$1 = G__57391;
continue;
} else {
...
var caller = orchestra_cljs.spec.test.find_caller((function (){var G__57349 = orchestra_cljs.spec.test.get_host_port();
var G__57350 = (new Error()).stack;
var G__57351 = orchestra_cljs.spec.test.get_env();
var G__57352 = null;
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__57349,G__57350,G__57351,G__57352) : cljs.stacktrace.parse_stacktrace.call(null,G__57349,G__57350,G__57351,G__57352));
})());
var via = (function (){var temp__5806__auto__ = (function (){var fexpr__57353 = new cljs.core.Var(function(){return cljs.spec.alpha.spec_name;},new cljs.core.Symbol("cljs.spec.alpha","spec-name","cljs.spec.alpha/spec-name",888422400,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.spec.alpha","cljs.spec.alpha",505122844,null),new cljs.core.Symbol(null,"spec-name","spec-name",-1420007703,null),"cljs/spec/alpha.cljs",17,1,93,93,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"spec","spec",1988051928,null)], null)),null,(cljs.core.truth_(cljs.spec.alpha.spec_name)?cljs.spec.alpha.spec_name.cljs$lang$test:null)]));
return (fexpr__57353.cljs$core$IFn$_invoke$arity$1 ? fexpr__57353.cljs$core$IFn$_invoke$arity$1(spec) : fexpr__57353.call(null,spec));
})();
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Call to ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var fexpr__57359 = new cljs.core.Var(function(){return cljs.spec.alpha.__GT_sym;},new cljs.core.Symbol("cljs.spec.alpha","->sym","cljs.spec.alpha/->sym",-2031271081,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.spec.alpha","cljs.spec.alpha",505122844,null),new cljs.core.Symbol(null,"->sym","->sym",696606926,null),"cljs/spec/alpha.cljs",13,1,323,323,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"x","x",-555367584,null)], null)),"Returns a symbol from a symbol or var",(cljs.core.truth_(cljs.spec.alpha.__GT_sym)?cljs.spec.alpha.__GT_sym.cljs$lang$test:null)]));
return (fexpr__57359.cljs$core$IFn$_invoke$arity$1 ? fexpr__57359.cljs$core$IFn$_invoke$arity$1(v__$1) : fexpr__57359.call(null,v__$1));
})())," did not conform to spec:\n",(function (){var sb__4661__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57360_57401 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57361_57402 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57362_57403 = true;
var _STAR_print_fn_STAR__temp_val__57363_57404 = ((function (_STAR_print_newline_STAR__orig_val__57360_57401,_STAR_print_fn_STAR__orig_val__57361_57402,_STAR_print_newline_STAR__temp_val__57362_57403,sb__4661__auto__,caller,via,ed,conformed,fn_spec){
return (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});})(_STAR_print_newline_STAR__orig_val__57360_57401,_STAR_print_fn_STAR__orig_val__57361_57402,_STAR_print_newline_STAR__temp_val__57362_57403,sb__4661__auto__,caller,via,ed,conformed,fn_spec))
;
cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57362_57403;

cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57363_57404;

try{cljs.spec.alpha.explain_out(ed);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57361_57402;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57360_57401;
}
...
var ret = (function (){var _STAR_instrument_enabled_STAR__orig_val__57364 = orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_;
var _STAR_instrument_enabled_STAR__temp_val__57365 = true;
orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = _STAR_instrument_enabled_STAR__temp_val__57365;

try{return apply_SINGLEQUOTE_(f,args);
}finally {orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = _STAR_instrument_enabled_STAR__orig_val__57364;
}})();
...
var temp__5804__auto___57406 = new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(fn_spec);
if(cljs.core.truth_(temp__5804__auto___57406)){
var spec_57407 = temp__5804__auto___57406;
if((cargs == null)){
throw orchestra_cljs.spec.test.no_args_spec(v,fn_spec);
} else {
conform_BANG_(v,new cljs.core.Keyword(null,"fn","fn",-1175266204),spec_57407,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ret","ret",-468222814),(function (){var or__4131__auto__ = cret;
...
return ret;
}finally {orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = orig__57175__auto__;
}} else {
return apply_SINGLEQUOTE_(f,args);
}
};
var G__57405 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57412__i = 0, G__57412__a = new Array(arguments.length -  0);
while (G__57412__i < G__57412__a.length) {G__57412__a[G__57412__i] = arguments[G__57412__i + 0]; ++G__57412__i;}
  args = new cljs.core.IndexedSeq(G__57412__a,0,null);
} 
return G__57405__delegate.call(this,args);};
G__57405.cljs$lang$maxFixedArity = 0;
G__57405.cljs$lang$applyTo = (function (arglist__57414){
var args = cljs.core.seq(arglist__57414);
return G__57405__delegate(args);
});
G__57405.cljs$core$IFn$_invoke$arity$variadic = G__57405__delegate;
return G__57405;
})()
...
var temp__5808__auto___57440 = f.cljs$core$IFn$_invoke$arity$variadic;
if((temp__5808__auto___57440 == null)){
} else {
var variadic_57442 = temp__5808__auto___57440;
ret.cljs$core$IFn$_invoke$arity$variadic = ((function (variadic_57442,temp__5808__auto___57440,fn_spec,conform_BANG_,pure_variadic_QMARK_,apply_SINGLEQUOTE_,ret){
return (function() { 
var G__57443__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(variadic_57442,args);
};
...
while (G__57445__i < G__57445__a.length) {G__57445__a[G__57445__i] = arguments[G__57445__i + 0]; ++G__57445__i;}
  args = new cljs.core.IndexedSeq(G__57445__a,0,null);
} 
return G__57443__delegate.call(this,args);};
G__57443.cljs$lang$maxFixedArity = 0;
G__57443.cljs$lang$applyTo = (function (arglist__57446){
var args = cljs.core.seq(arglist__57446);
return G__57443__delegate(args);
});
G__57443.cljs$core$IFn$_invoke$arity$variadic = G__57443__delegate;
return G__57443;
})()
;})(variadic_57442,temp__5808__auto___57440,fn_spec,conform_BANG_,pure_variadic_QMARK_,apply_SINGLEQUOTE_,ret))
;
}
}
 ...
 */
orchestra_cljs.spec.test.instrument_choose_fn = (function orchestra_cljs$spec$test$instrument_choose_fn(f,spec,sym,p__57374){
var map__57375 = p__57374;
...
var over = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57375__$1,new cljs.core.Keyword(null,"gen","gen",142575302));
var stub = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57375__$1,new cljs.core.Keyword(null,"stub","stub",1339145807));
var replace = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57375__$1,new cljs.core.Keyword(null,"replace","replace",-786587770));
 ...
 * Helper for instrument
 */
orchestra_cljs.spec.test.instrument_choose_spec = (function orchestra_cljs$spec$test$instrument_choose_spec(spec,sym,p__57378){
...
var overrides = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57379__$1,new cljs.core.Keyword(null,"spec","spec",347520401));
...
var map__57382 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(orchestra_cljs.spec.test.instrumented_vars),v);
...
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57382__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
var wrapped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57382__$1,new cljs.core.Keyword(null,"wrapped","wrapped",1775172701));
...
var map__57386 = temp__5804__auto__;
...
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57386__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
var wrapped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57386__$1,new cljs.core.Keyword(null,"wrapped","wrapped",1775172701));
