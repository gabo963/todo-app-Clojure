...
clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k45488,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45488,else__4388__auto__);
...
clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45487){
var self__ = this;
var G__45487__$1 = this;
return (new cljs.core.RecordIter((0),G__45487__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4243__auto____$1 = (function (){var fexpr__45497 = ((function (h__4243__auto__,this__4381__auto____$1){
return (function (coll__4382__auto__){
return (-12654282 ^ cljs.core.hash_unordered_coll(coll__4382__auto__));
});})(h__4243__auto__,this__4381__auto____$1))
;
return fexpr__45497(this__4381__auto____$1);
})();
...
clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45489,other45490){
var self__ = this;
var this45489__$1 = this;
return (((!((other45490 == null)))) && ((this45489__$1.constructor === other45490.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45489__$1.error,other45490.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45489__$1.__extmap,other45490.__extmap)));
});
...
clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__45487){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__45498 = cljs.core.keyword_identical_QMARK_;
var expr__45499 = k__4393__auto__;
if(cljs.core.truth_((function (){var G__45501 = new cljs.core.Keyword(null,"error","error",-978969032);
...
return (new clojure.test.check.properties.ErrorResult(G__45487,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__45487),null));
}
});
...
clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__45487){
var self__ = this;
var this__4384__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__45487,self__.__extmap,self__.__hash));
});
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__45491){
var extmap__4424__auto__ = (function (){var G__45508 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45491,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__45491)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45508);
} else {
return G__45508;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__45491),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
